...
// PassphraseWordList is a curated list of 1885 common English words used for
// generating high-entropy passphrases. Entropy per word: log2(1885) ≈ 10.88 bits.
// A 6-word passphrase yields ≈ 65 bits; a 12-word passphrase yields ≈ 130 bits.
//
// This list is intentionally kept inline (not go:embed) so that the exact
// words are auditable as Go source and reviewed alongside the code that uses them.
// Do NOT reorder entries — it would invalidate any stored passphrases.
var PassphraseWordList = []string{
	...
	"always", "amaze", "amount", "amuse", "analyst", "anchor", "ancient", "anger", "angle", "angry",
	...
	"awful", "awkward", "baby", "bachelor", "bacon", "badge", "bag", "balance", "balcony", "ball",
	...
	"chuckle", "chunk", "cigar", "cinema", "circle", "citizen", "city", "civil", "claim", "clap",
	...
	"egg", "eight", "either", "elbow", "elder", "electric", "elegant", "element", "elephant", "elite",
	"else", "embark", "embody", "embrace", "emerge", "emotion", "employ", "empower", "empty", "enable",
	"enact", "endless", "endorse", "enemy", "energy", "enforce", "engage", "engine", "enhance", "enjoy",
	"enlist", "enough", "enrich", "ensure", "enter", "entire", "entry", "envelope", "episode", "equal",
	...
	"february", "federal", "fee", "feed", "feel", "feet", "fellow", "felt", "festival", "fetch",
	...
	"foil", "follow", "food", "foot", "force", "forest", "forget", "fork", "fortune", "forum",
	"forward", "fossil", "foster", "found", "fox", "fragile", "frame", "frequent", "fresh", "friend",
	"fringe", "frog", "front", "frown", "frozen", "fruit", "fuel", "fun", "funny", "furnace",
	"fury", "future", "gadget", "gain", "galaxy", "gallery", "game", "gap", "garage", "garbage",
	"garden", "garlic", "garment", "gasp", "gate", "gauge", "gaze", "general", "genius", "genre",
	...
	"holiday", "hollow", "home", "honey", "hood", "hope", "horn", "horse", "hospital", "host",
	"hour", "hover", "hub", "humble", "humor", "hundred", "hungry", "hunt", "hurdle", "hurry",
	"hurt", "husband", "hybrid", "ice", "icon", "ignore", "ill", "illegal", "image", "imitate",
	"immense", "immune", "impact", "impose", "improve", "impulse", "inbox", "income", "increase", "index",
	"indicate", "indoor", "industry", "infant", "inform", "inhale", "inject", "inner", "innocent", "input",
	...
	"jar", "jazz", "jealous", "jelly", "jewel", "job", "join", "joke", "journey", "joy",
	"judge", "juice", "jump", "jungle", "junior", "junk", "just", "kangaroo", "keen", "keep",
	"ketchup", "key", "kick", "kid", "kidney", "kind", "kingdom", "kiss", "kit", "kitchen",
	"kite", "kitten", "kiwi", "knee", "knife", "knock", "know", "lab", "label", "lamp",
	"language", "laptop", "large", "later", "laugh", "laundry", "lava", "lawn", "lawsuit", "layer",
	"lazy", "leader", "learn", "leave", "lecture", "left", "legal", "legend", "lemon", "lend",
	"length", "lens", "leopard", "lesson", "letter", "level", "liar", "liberty", "library", "license",
	"life", "lift", "like", "limb", "lion", "liquid", "list", "little", "live", "lizard",
	"load", "loan", "lobster", "local", "lock", "logic", "lonely", "long", "loop", "lottery",
	"loud", "loyal", "lucky", "luggage", "lumber", "lunar", "lunch", "luxury", "machine", "mad",
	"magic", "magnet", "maid", "main", "mammal", "manage", "mandate", "mango", "mansion", "manual",
	"maple", "marble", "march", "margin", "marine", "market", "marriage", "mask", "master", "match",
	"material", "math", "matrix", "matter", "maximum", "maze", "medal", "media", "melody", "melt",
	"member", "memory", "mental", "mention", "mercy", "mesh", "message", "metal", "method", "middle",
	"midnight", "milk", "million", "mimic", "mind", "minimum", "minor", "minute", "miracle", "miss",
	"mistake", "mix", "model", "modify", "mom", "monitor", "monkey", "monster", "month", "moon",
	"moral", "mother", "motion", "motor", "mountain", "mouse", "move", "movie", "much", "muffin",
	...
	"negative", "neglect", "neither", "nephew", "nerve", "network", "news", "next", "nice", "night",
	...
	"obscure", "obtain", "ocean", "october", "odor", "offer", "office", "often", "oil", "okay",
	...
	"other", "outdoor", "outside", "oval", "over", "own", "oxygen", "oyster", "pact", "paddle",
	"page", "pair", "palace", "panther", "paper", "parade", "parent", "park", "parrot", "party",
	"pass", "patch", "path", "patrol", "pause", "pave", "payment", "peace", "peanut", "peasant",
	"pelican", "penalty", "pencil", "people", "pepper", "perfect", "permit", "person", "pet", "phone",
	"photo", "phrase", "physical", "piano", "picnic", "piece", "pigeon", "pill", "pilot", "pink",
	...
	"protect", "proud", "provide", "public", "pudding", "pull", "pulp", "pulse", "pumpkin", "pupil",
	"purchase", "purity", "purpose", "push", "put", "quality", "quantum", "quarter", "question", "quick",
	"quit", "quiz", "rabbit", "raccoon", "race", "rack", "radar", "radio", "rage", "rail",
	...
	"reward", "rhythm", "ribbon", "ride", "rifle", "right", "rigid", "ring", "riot", "ripple",
	...
	"sausage", "save", "say", "scale", "scan", "scatter", "scene", "scheme", "scissors", "scorpion",
	"scout", "scrap", "screen", "script", "scrub", "sea", "search", "season", "seat", "second",
	"secret", "section", "security", "seek", "segment", "select", "sell", "seminar", "sense", "sentence",
	...
	"sing", "siren", "sister", "situate", "six", "size", "sketch", "ski", "skill", "skin",
	"skirt", "skull", "slab", "slam", "sleep", "slender", "slice", "slide", "slim", "slogan",
	...
	"subway", "success", "such", "sudden", "suffer", "sugar", "suggest", "suit", "sunny", "sunset",
	"super", "supply", "supreme", "sure", "surface", "surge", "surprise", "sustain", "swallow", "swamp",
	"swap", "swear", "sweet", "swift", "swim", "swing", "switch", "sword", "symbol", "table",
	"tackle", "tag", "tail", "talent", "tank", "tape", "target", "task", "tattoo", "teach",
	"team", "tell", "ten", "tenant", "tennis", "tent", "term", "test", "text", "thank",
	"that", "theme", "then", "theory", "there", "they", "thing", "this", "thought", "three",
	"thrive", "throw", "thumb", "ticket", "tilt", "timber", "time", "tiny", "tip", "tired",
	...
	"twelve", "twenty", "twice", "twin", "twist", "two", "type", "ugly", "umbrella", "unable",
	...
	"upper", "upset", "urban", "useful", "useless", "usual", "utility", "vacant", "vacuum", "vague",
	"valid", "valley", "valve", "van", "vanish", "vapor", "various", "vast", "vault", "vehicle",
	"velvet", "vendor", "venture", "verb", "verify", "version", "very", "veteran", "viable", "vibrant",
	...
	"when", "where", "whip", "whisper", "wide", "width", "wife", "wild", "will", "window",
