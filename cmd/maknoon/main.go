...
Post-Quantum Cryptography (PQC).`,
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			_ = viper.BindPFlag("passphrase_fd", cmd.Root().PersistentFlags().Lookup("passphrase-fd"))
	...
	rootCmd.PersistentFlags().Int("passphrase-fd", 0, "Read passphrase from file descriptor N (e.g., --passphrase-fd 3  3<<<$(pass show key)). Also settable via MAKNOON_PASSPHRASE_FD")
	...
	addCommand(commands.ReencryptCmd(), "core")
