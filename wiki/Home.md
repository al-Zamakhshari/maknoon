...
*   **Fingerprint Resistance (Stealth Mode)**: Optional headerless encryption to make ciphertext indistinguishable from random noise.
...
## 📖 Table of Contents
1.  [[Architecture]] - Deep dive into the V2 streaming engine.
